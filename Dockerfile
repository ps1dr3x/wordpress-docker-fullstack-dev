...
RUN apt-get update && \
    ...
    apt-get -y install curl net-tools ssl-cert nano vim tmux dos2unix less apache2 apache2-utils libapache2-mod-php php php-mysql php-xdebug php-curl php-mbstring composer mariadb-client && \
    apt-get clean && \
